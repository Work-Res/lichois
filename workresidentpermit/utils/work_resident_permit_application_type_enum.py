...
class WorkResidentPermitApplicationTypeEnum(Enum):
    ...
    WORK_PERMIT_VARIATION = "WORK_PERMIT_VARIATION"
    ...
    WORK_RESIDENT_PERMIT_EMERGENCY_REPLACEMENT = "WORK_RESIDENT_PERMIT_EMERGENCY_REPLACEMENT"
    ...
    WORK_RESIDENT_PERMIT_VARIATION = "WORK_RESIDENT_PERMIT_VARIATION"
    ...
    EXEMPTION_CERTIFICATE_VARIATION = "EXEMPTION_CERTIFICATE_VARIATION"
