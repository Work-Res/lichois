class PermitRequestDTO:
    ...
    def __init__(self, document_number=None, permit_type=None, date_issued=None, date_expiry=None, place_issue=None,
                 security_number=None, permit_no=None, application_type=None):
