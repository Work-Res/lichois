...
from .views import ChildCreateListView, EmergencyResPermitApplicationViewSet, EmergencyResidencePermitViewSet, \
    ExemptionCertificateViewSet, PermitCreateListView, ResidencePermitCancellationViewSet, ResidencePermitViewSet, \
    SpouseCreateListView, \
    WorkPermitViewSet, WorkResidentPermitApplicationDetailView
