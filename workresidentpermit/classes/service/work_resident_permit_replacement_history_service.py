...
class WorkResidentPermitReplacementHistoryService:
    ...
    def create_application_replacement_history(self):

        historical = ApplicationReplacementHistory.objects.update_or_create(
            application_type=self.application_type,
            application_user=self.application_user,
            process_name=self.process_name,
            defaults={
