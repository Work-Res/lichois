...
class GenerateProductionPermitPDF:
    ...
    def __init__(self, document_number: str, file_location: Optional[str] = None, configuration_file_name=None):
        """
        ...
        self.data_processor = PermitDataProcessor(document_number=document_number,
