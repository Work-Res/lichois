...
class ResidencePermit(ApplicationBaseModel):
	...
	permit_reason = models.TextField(verbose_name='Give reasons for applying for a permit')
	...
	reason_applying_permit = models.CharField(max_length=190, choices=REASONS_PERMIT, null=True, blank=True,
