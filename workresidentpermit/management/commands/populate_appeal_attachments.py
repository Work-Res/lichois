...
class Command(BaseAttachmentCommand):
    ...
    def handle(self, *args, **options):
        ...
        application_checklist_mapping = {
            WorkResidentPermitApplicationTypeEnum.RESIDENT_PERMIT_APPEAL.value: "RESIDENT_PERMIT_APPEAL_ATTACHMENT_DOCUMENTS",
            WorkResidentPermitApplicationTypeEnum.WORK_PERMIT_APPEAL.value: "WORK_PERMIT_APPEAL_ATTACHMENT_DOCUMENTS",
            WorkResidentPermitApplicationTypeEnum.WORK_RESIDENT_PERMIT_APPEAL.value: "WORK_RESIDENT_PERMIT_APPEAL_ATTACHMENT_DOCUMENTS",
            WorkResidentPermitApplicationTypeEnum.EXEMPTION_CERTIFICATE_APPEAL.value: "EXEMPTION_CERTIFICATE_APPEAL_ATTACHMENT_DOCUMENTS",
