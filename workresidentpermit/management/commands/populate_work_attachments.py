...
class Command(BaseAttachmentCommand):
    ...
    def handle(self, *args, **options):
        ...
        application_checklist_mapping = {
            WorkResidentPermitApplicationTypeEnum.WORK_PERMIT_ONLY.value: "WORK_PERMIT_ONLY_ATTACHMENT_DOCUMENTS",
            WorkResidentPermitApplicationTypeEnum.WORK_PERMIT_RENEWAL.value: "WORK_PERMIT_RENEWAL_ATTACHMENT_DOCUMENTS",
            WorkResidentPermitApplicationTypeEnum.WORK_PERMIT_REPLACEMENT.value: "WORK_PERMIT_REPLACEMENT_ATTACHMENT_DOCUMENTS",
            WorkResidentPermitApplicationTypeEnum.WORK_PERMIT_VARIATION.value: "WORK_PERMIT_VARIATION_ATTACHMENT_DOCUMENTS",
        }
