...
class Command(BaseAttachmentCommand):
    ...
    def handle(self, *args, **options):
        ...
        application_checklist_mapping = {
            WorkResidentPermitApplicationTypeEnum.RESIDENT_PERMIT_ONLY.value: "RESIDENT_PERMIT_ONLY_ATTACHMENT_DOCUMENTS",
            WorkResidentPermitApplicationTypeEnum.RESIDENT_PERMIT_RENEWAL.value: "RESIDENT_PERMIT_RENEWAL_ATTACHMENT_DOCUMENTS",
            WorkResidentPermitApplicationTypeEnum.RESIDENT_PERMIT_REPLACEMENT.value: "RESIDENT_PERMIT_REPLACEMENT_ATTACHMENT_DOCUMENTS",
        }
