...
class Command(BaseAttachmentCommand):
    ...
    def handle(self, *args, **options):
        ...
        application_checklist_mapping = {
            WorkResidentPermitApplicationTypeEnum.EXEMPTION_CERTIFICATE.value: "EXEMPTION_CERTIFICATE_ATTACHMENT_DOCUMENTS",
            WorkResidentPermitApplicationTypeEnum.EXEMPTION_CERTIFICATE_RENEWAL.value: "EXEMPTION_CERTIFICATE_RENEWAL_ATTACHMENT_DOCUMENTS",
            WorkResidentPermitApplicationTypeEnum.EXEMPTION_CERTIFICATE_REPLACEMENT.value: "EXEMPTION_CERTIFICATE_REPLACEMENT_ATTACHMENT_DOCUMENTS",
            WorkResidentPermitApplicationTypeEnum.EXEMPTION_CERTIFICATE_VARIATION.value: "EXEMPTION_CERTIFICATE_VARIATION_ATTACHMENT_DOCUMENTS",
