...
class NaturalisationApplication:
    ...
    def __init__(self):
        ...
        self._naturalisation_application = None
    ...
    def naturalisation_application(self):
        return self._naturalisation_application

    @naturalisation_application.setter
    def naturalisation_application(self, value):
        self._naturalisation_application = value
