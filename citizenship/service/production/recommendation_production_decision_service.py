...
class RecommendationProductionDecisionService(ApplicationDecisionService):
    ...
    def decision_predicate(self):
        if (
            ...
            in RecommendationDecisionProcessWhenCompletedIsRequiredForProduction.configured_process()
        ):
            return True
        return False
