...
from app.utils.verification_process_is_trigger_for_production import (
     ForeignRenunciationProcessWhenCompletedIsRequiredForProduction,
)


class ForeignSpouseProductionDecisionService(ApplicationDecisionService):
    ...
    def decision_predicate(self):
        if (
            ...
            in ForeignRenunciationProcessWhenCompletedIsRequiredForProduction.configured_process()
        ):
            return True
        return False
