...
from citizenship.models.president10b.validators import (
...
class FormL(ApplicationBaseModel, DeclarationModelMixin, CommissionerOathModelMixin):
    ...
    residency_periods = models.ManyToManyField(
        ResidencyPeriod, related_name="form_l_residency_periods"
    )

    languages = models.ManyToManyField(
        LocalLanguageKnowledge, related_name="form_l_languages"
    )
    ...
    criminal_offences = models.ManyToManyField(
        CriminalOffense, related_name="form_l_criminal_offences"
    )

    countries_of_residence = models.ManyToManyField(
        CountryOfResidence, related_name="form_l_countries_of_residence"
    )
    ...
    def clean(self):
        ...
        validate_citizenship_loss_circumstances(
            self.present_nationality, self.citizenship_loss_circumstances
        )
