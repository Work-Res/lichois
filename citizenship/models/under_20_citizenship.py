...
class Under20Citizenship(CommissionerOathModelMixin,
    ...
    guardian_father_details_id = models.CharField(max_length=25)
    guardian_mother_details_id = models.CharField(max_length=25)
