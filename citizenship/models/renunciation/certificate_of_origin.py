...
class CertificateOfOrigin(BaseUuidModel):
    ...
    father = models.ForeignKey(Person, on_delete=models.CASCADE, null=True, blank=True,
                               related_name="certificate_of_origin_fathers")

    mother = models.ForeignKey(Person, on_delete=models.CASCADE, null=True, blank=True,
