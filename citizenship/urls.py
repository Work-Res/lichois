...
# from .views import ( CertificateOfOriginViewSet, RenunciationSummaryViewSet, BoardRecommendationViewSet)
...
# router.register(r'citizenship-board-decisions', DecisionViewSet, basename='decision')
...
# router.register(r'board-recommandations', BoardRecommendationViewSet, basename='boardrecommandations')
