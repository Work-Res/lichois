...
from services.form_models import exemption_certificate
from ..service_application_view_mixin import ServiceApplicationViewMixin


class ExemptionCertificateDashboardView(TemplateView, ServiceApplicationViewMixin):
    template_name = 'applications/work-res/work-res-dashboard.html'

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)

        model_cls_list = exemption_certificate  # This could come from a config file
