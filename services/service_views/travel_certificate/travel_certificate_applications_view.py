...
from services.form_models import travel_certificate
from ..service_application_view_mixin import ServiceApplicationViewMixin


class TravelCertificateDashboardView(TemplateView, ServiceApplicationViewMixin):
    template_name = 'applications/work-res/work-res-dashboard.html'

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
    
        model_cls_list = travel_certificate # This could come from a config file
