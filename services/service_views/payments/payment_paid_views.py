...
class PaymentsPaidView(TemplateView, ApplicationDetailsViewMixin):
    ...
    def get_context_data(self, **kwargs):
        ...
        if non_citizen_identifier:
            payments = Payment.objects.filter(status="PAID") # non_citizen_identifier=non_citizen_identifier
        else:
