...
from services.form_models import PermitCancellation, PermitCancellationReason
...
class WorkPermitCancellationView(TemplateView, ServiceApplicationViewMixin):
    ...
    def get_context_data(self, **kwargs):
        ...
        model_cls_list = [ PermitCancellation , PermitCancellationReason ]  # This could come from a config file
