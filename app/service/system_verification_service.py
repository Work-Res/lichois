...
from app.api.dto.application_verification_request_dto import ApplicationVerificationRequestDTO
...
class SystemVerificationService:
    ...
    def __init__(self, document_number, verification_request: ApplicationVerificationRequestDTO, user=None):
