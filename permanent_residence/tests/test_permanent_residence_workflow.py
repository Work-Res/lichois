...
class TestPermanentResidenceWorkflow(BaseTestSetup):
    ...
    def create_new_application(self):
        self.new_application_dto = NewApplicationDTO(
            ...
            dob="06101990",
            work_place="01",
            application_type=ApplicationProcesses.PERMANENT_RESIDENCE.value,
            full_name="Test test",
    ...
    def test_create_new_application_workflow_records(self):
        ...
        self.assertEqual(app.process_name, ApplicationProcesses.PERMANENT_RESIDENCE.value)
        activites = Activity.objects.filter(
            process__document_number=self.document_number
        )
        self.assertEqual(5, activites.count())
        self.assertEqual(
