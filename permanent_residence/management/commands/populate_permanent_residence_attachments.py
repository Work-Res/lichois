...
from ...enums import PermanentResidenceApplicationTypeEnum
...
class Command(BaseAttachmentCommand):
    ...
    def handle(self, *args, **options):
        ...
        application_checklist_mapping = {
            PermanentResidenceApplicationTypeEnum.PERMANENT_RESIDENCE_ONLY.value: "PERMANENT_RESIDENCE_ONLY_ATTACHMENT_DOCUMENTS",
            PermanentResidenceApplicationTypeEnum.PERMANENT_RESIDENCE_10_YEARS.value: "PERMANENT_RESIDENCE_10_YEARS_ATTACHMENT_DOCUMENTS",
        }
