...
class ExemptionCertApplicationData(object):
    ...
    def prepare(self):
        self.exemption_cert_application_details.personal_details = (
        ...
        self.exemption_cert_application_details.exemption_cert_application = (
            self.exemption_cert_application()
        )
    ...
    def exemption_cert_application(self):
        return self.get_model_class(
            ExemptionCertificateApplication._meta.app_label.lower()
        )
    ...
    def get_model_class(self, model_string):
        try:
            ...
            try:
                form_details = model_cls.objects.get(
