...
class ExemptionCertApplicationDetails:
    ...
    def __init__(self):
        ...
        self._exemption_cert_application = None
    ...
    def exemption_cert_application(self):
        return self._exemption_cert_application

    @exemption_cert_application.setter
    def exemption_cert_application(self, value):
        self._exemption_cert_application = value
