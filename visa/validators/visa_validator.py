...
class VisaValidator:
    ...
    def __init__(
        ...
        try:
            ...
            self.visa_application = visa_application
    ...
    def find_missing_mandatory_fields(self):
        models_to_check = {
            ...
            VisaApplication: "Travel certificate details are missing. Please submit the form.",
            VisaReference: "Applicant relative details are missing.",
            ApplicationContact:"Preferred method of contact is missing.",
            DisposalMoney:"Disposal money data is missing.",
        }
